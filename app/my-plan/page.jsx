      ...
      <section className="container-x py-12 md:py-16 ">
        ...
        <div className="mt-8 grid grid-cols-3 gap-4">
          <div className="card p-5 text-center">
            <p className="font-display text-3xl font-bold text-accent">{plan.length}</p>
            <p className="mt-1 text-xs font-semibold uppercase tracking-wide text-muted">
              Exercises
            </p>
          </div>
          <div className="card p-5 text-center">
            <p className="font-display text-3xl font-bold text-accent">{totals.minutes}</p>
            <p className="mt-1 text-xs font-semibold uppercase tracking-wide text-muted">
              Minutes
            </p>
          </div>
          <div className="card p-5 text-center">
            <p className="font-display text-3xl font-bold text-accent">{totals.calories}</p>
            <p className="mt-1 text-xs font-semibold uppercase tracking-wide text-muted">
              Calories
            </p>
          </div>
        ...
        <div className="mt-6 flex flex-col gap-4">
          ...
          {hydrated &&
            list.map((workout) => (
              <PlanWorkoutCard key={workout.id} workout={workout} tab={tab} />
            ))}
        </div>
      </section>
    </div>
